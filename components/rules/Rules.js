...
export default class Regeln extends page {
  ...
  addExamplesPage() {
    ...
    columnLeft.innerHTML = `
		...
		<p>Der Schurke meint, er möchte versuchen das Türschloss zu knacken. Der Erzähler stimmt zu, und fordert eine Probe auf Geschick gegen eine 12.</p>
		...
		<p>Der Barbar der Gruppe ist wegen der Verzö-gerung genervt und kündigt and die Tür einzu-schlagen. Der Erzähler stimmt zu und verlang erneut eine 12. Da die Probe recht schwer ist, benutzt der Barbar einen Stunt um einen Vor-teil auf seine Probe zu erhalten.</p>
